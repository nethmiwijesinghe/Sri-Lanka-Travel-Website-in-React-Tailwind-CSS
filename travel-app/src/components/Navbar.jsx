  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
        ...
        py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
            ...
            <img src="src/assets/logonew.png" alt="" className='w-20'/>
            <ul className='hidden md:flex gap-7 text-white'>
                <a href='#Header' className='cursor-pointer
                hover:text-gray-400'>Home</a>
                <a href='#About' className='cursor-pointer
                hover:text-gray-400'>About</a>
                <a href='#Destination' className='cursor-pointer
                hover:text-gray-400'>Destination</a>
        ...
        <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'}  right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
            ...
            font-medium'>
                ...
                <a  onClick={()=> setshowMobileMenu(false)}href="#Destination" className='px-4 py-2 rounded-full inline-block'>Destination</a>
